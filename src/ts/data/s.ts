export class s {
    ...
    static readonly maxChars : string = "Reached maximum allowed characters";
    ...
    static readonly thankYou : string = "Thank you";
    ...
    static readonly languageUnavailable : string = "This language is currently unavailable.";
    static readonly openNumpad : string = "Tap here to open numpad";
}